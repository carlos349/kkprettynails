        ...
        <div style="width: 800px;margin: auto;padding-top: 5%;font-family: 'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;color:#172b4d;padding-bottom: 20px;">
            <center>
                <div style="width:80%;text-align: center;">
                    ...
                    <img style="width:30%;margin-top:10px !important;border-radius: 50%;" src="http://kkprettynails.cl/views/images/logokk.png" alt=""> <br>
                    ...
                    <img style="width:100%;" src="http://kkprettynails.cl/views/images/giftModelBot.png" alt="">
                <div>
            </center>
        </div>
